const qnaList = [
    {
        q: '아이스크림을 먹다가 잠에 들었다... 눈을 떠보니 아이스크림이 걸어다니는 이상한 마을인 것 같다. 이럴 때 나는?',
        a: [
    ...
    {
        q: '책상 위에 음식이 놓여있고, 쪽지에 "아무 이상은 없지만 아무도 먹지 않았습니다. 하지만 드셔도 됩니다”라고 적혀있다. 나의 생각은?',
        a: [
            { answer: '왜 이상이 없는데 아무도 안먹었지? 왜 두번 꼬아서 말한거지? 함정인가? 이거 먹고 쓰러지면 누가 데려가지? 먹기 전에 119에 전화하고 먹을까? ', type: 'N'},
            { answer: '찝찝하지만 일단 너무 배가 고프니까 먹자.', type: 'S'},
        ]
    },
    {
        q: '마을을 돌아다니다 공원에서 놀고 있는 아이스크림 친구들을 발견했다. 친구들이 날 보더니 같이 놀자고 한다. 나의 대답은?',
        a: [
    ...
    {
        q: '아이스크림 친구들과 다과집으로 향하던 중 한 친구가 아끼던 드라이아이스를 잃어버렸다고 한다. 이때 내가 해줄 말은?',
        a: [
    ...
    {
        q: '아이스크림 친구에게 집들이 초대를 받았다. 다 놀고 재밌게 노느라 어질러진 방을 보고 드는 생각은?',
        a: [
